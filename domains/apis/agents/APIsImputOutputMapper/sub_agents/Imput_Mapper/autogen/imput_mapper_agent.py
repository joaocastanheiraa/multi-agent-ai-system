...
class Imput_Mapper_Agent(autogen.AssistantAgent):
    """
    Imput_Mapper - Specialized AutoGen Agent
    Domain: apis
    Parent: APIsImputOutputMapper
    """
    
    def __init__(self, name: str = "Imput_Mapper", **kwargs):
        system_message = """
Você é Imput_Mapper, um agente especializado do domínio apis.
