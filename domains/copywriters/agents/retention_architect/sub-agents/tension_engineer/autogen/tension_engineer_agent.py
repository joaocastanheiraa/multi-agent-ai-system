#!/usr/bin/env python3
"""
AutoGen Agent: tension_engineer
Domain: copywriters
...
class tension_engineer_Agent(autogen.AssistantAgent):
    """
    tension_engineer - Specialized AutoGen Agent
    Domain: copywriters
    Parent: retention_architect
    """
    
    def __init__(self, name: str = "tension_engineer", **kwargs):
        system_message = """
Você é tension_engineer, um agente especializado do domínio copywriters.
