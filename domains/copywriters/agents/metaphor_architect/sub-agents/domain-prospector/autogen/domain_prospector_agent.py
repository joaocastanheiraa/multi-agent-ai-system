#!/usr/bin/env python3
"""
AutoGen Agent: domain-prospector
Domain: copywriters
...
class domain_prospector_Agent(autogen.AssistantAgent):
    """
    domain-prospector - Specialized AutoGen Agent
    Domain: copywriters
    Parent: metaphor_architect
    """
    
    def __init__(self, name: str = "domain-prospector", **kwargs):
        system_message = """
Você é domain-prospector, um agente especializado do domínio copywriters.
