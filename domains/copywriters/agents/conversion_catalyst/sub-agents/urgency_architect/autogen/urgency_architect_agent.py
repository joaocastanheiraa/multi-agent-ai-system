#!/usr/bin/env python3
"""
AutoGen Agent: urgency_architect
Domain: copywriters
...
class urgency_architect_Agent(autogen.AssistantAgent):
    """
    urgency_architect - Specialized AutoGen Agent
    Domain: copywriters
    Parent: conversion_catalyst
    """
    
    def __init__(self, name: str = "urgency_architect", **kwargs):
        system_message = """
Você é urgency_architect, um agente especializado do domínio copywriters.
