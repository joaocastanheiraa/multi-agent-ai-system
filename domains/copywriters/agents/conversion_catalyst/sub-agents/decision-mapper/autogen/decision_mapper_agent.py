...
class decision_mapper_Agent(autogen.AssistantAgent):
    """
    decision-mapper - Specialized AutoGen Agent
    Domain: copywriters
    Parent: conversion_catalyst
    """
    
    def __init__(self, name: str = "decision-mapper", **kwargs):
        system_message = """
Você é decision-mapper, um agente especializado do domínio copywriters.
