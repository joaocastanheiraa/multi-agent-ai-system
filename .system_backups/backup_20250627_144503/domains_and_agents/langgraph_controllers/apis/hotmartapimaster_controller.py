#!/usr/bin/env python3
"""
🎯 HOTMARTAPIMASTER - CONTROLLER LANGGRAPH
...
class HotmartAPIMasterState(TypedDict):
    """Estado do agente HotmartAPIMaster"""
    messages: Annotated[list, add_messages]
    context: Dict[str, Any]

class HotmartAPIMasterController:
    """Controller LangGraph para HotmartAPIMaster"""
    ...
    def __init__(self):
        ...
        self.system_prompt = """You are HotmartAPIMaster, a specialized AI agent.
...
- Atualizado automaticamente com configurações reais"""
    ...
    def _build_graph(self) -> StateGraph:
        ...
        graph = StateGraph(HotmartAPIMasterState)
    ...
    def _agent_node(self, state: HotmartAPIMasterState) -> Dict[str, Any]:
...
hotmartapimaster_controller = HotmartAPIMasterController()

def process_hotmartapimaster(input_data: str, context: Dict[str, Any] = None) -> str:
    """Função de entrada para o agente HotmartAPIMaster"""
    return hotmartapimaster_controller.process(input_data, context)

if __name__ == "__main__":
    # Teste do controller
    test_input = "Olá, preciso de ajuda com apis"
    result = process_hotmartapimaster(test_input)
