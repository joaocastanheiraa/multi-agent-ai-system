#!/usr/bin/env python3
"""
AutoGen Agent: concept-dissector
Domain: copywriters
...
class concept_dissector_Agent(autogen.AssistantAgent):
    """
    concept-dissector - Specialized AutoGen Agent
    Domain: copywriters
    Parent: metaphor_architect
    """
    
    def __init__(self, name: str = "concept-dissector", **kwargs):
        system_message = """
Você é concept-dissector, um agente especializado do domínio copywriters.
