#!/usr/bin/env python3
"""
AutoGen Agent: rhythm_programmer
Domain: copywriters
...
class rhythm_programmer_Agent(autogen.AssistantAgent):
    """
    rhythm_programmer - Specialized AutoGen Agent
    Domain: copywriters
    Parent: retention_architect
    """
    
    def __init__(self, name: str = "rhythm_programmer", **kwargs):
        system_message = """
Você é rhythm_programmer, um agente especializado do domínio copywriters.
